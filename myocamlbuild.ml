...
dispatch begin
  ...
  | After_rules ->
    ...
    (* Linking cstubs *)
    dep ["c"; "compile"; "use_sys_resource_util"]
      ["unix/unix_sys_resource_util.o"; "unix/unix_sys_resource_util.h"];
    flag ["c"; "compile"; "use_ctypes"] & S[A"-I"; A ctypes_libdir];
    flag ["c"; "compile"; "debug"] & A"-g";

    (* Linking generated stubs *)
    dep ["ocaml"; "link"; "byte"; "library"; "use_sys_resource_stubs"]
      ["unix/dllunix_sys_resource_stubs"-.-(!Options.ext_dll)];
    flag ["ocaml"; "link"; "byte"; "library"; "use_sys_resource_stubs"] &
      S[A"-dllib"; A"-lunix_sys_resource_stubs"];

    dep ["ocaml"; "link"; "native"; "library"; "use_sys_resource_stubs"]
      ["unix/libunix_sys_resource_stubs"-.-(!Options.ext_lib)];
    flag ["ocaml"; "link"; "native"; "library"; "use_sys_resource_stubs"] &
      S[A"-cclib"; A"-lunix_sys_resource_stubs"];

    (* Linking tests *)
    flag ["ocaml"; "link"; "byte"; "program"; "use_sys_resource_stubs"] &
      S[A"-dllib"; A"-lunix_sys_resource_stubs"; A"-I"; A"unix/"];
    dep ["ocaml"; "link"; "native"; "program"; "use_sys_resource_stubs"]
      ["unix/libunix_sys_resource_stubs"-.-(!Options.ext_lib)];
